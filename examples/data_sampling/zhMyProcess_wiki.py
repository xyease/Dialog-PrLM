...
def tokenize(content):
    ...
    for para in content.split("\n"):
        result.append(para.encode('utf8'))
        # paralist = []
...
def process():
    ...
    #     sys.exit(1)
    inp, outp = "mydata/zhwiki-latest-pages-articles.xml.bz2", "mydata/zhwikitext/"
    space = " "
    i = 0
    ...
    for (text, (pageid, title)) in wiki.get_texts():
        ...
        # else:
        text = [str(token, 'utf-8').strip() for token in text if str(token, 'utf-8').strip()]
        # print(text)
        # mytext = ""
        # for para in text:
...
# 2020-11-18 10:36:46,886: INFO: finished iterating over Wikipedia corpus of 262405 documents with 104104746 positions (total 3599270 articles, 122826768 positions before pruning articles shorter than 50 words)
# 2020-11-18 10:36:46,887: INFO: Finished Saved 262405 articles