...
from bert_wiki_pretrain_model_3 import BertWIKIpretrainmodel
...
from utils_bert_wikipretrain_sot_3 import InsertDataProcessor, DeleteDataProcessor, ReplaceDataProcessor, convert_examples_to_features_sptoken_sot
...
parser.add_argument("--data_dir",
                    default="../../mydata/wikipretrain_v3/",
                    type=str,
...
parser.add_argument("--output_dir",
                    default="../../result/zh_wikipretrain_v3/model_save_v1_sptoken3_eot_p2",
                    type=str,
...
parser.add_argument("--input_cache_dir",
                    default="input_cache_v1_sptoken3_eot_p2",
                    type=str,
...
def eval_and_save(model, tokenizer, device, dataprocessor_list, best_mean_acc, best_result, global_step):
    model.eval()
    result = eval(model, tokenizer, device, dataprocessor_list, "eval")
...
def main():
    ...
    if args.do_train:
        ...
        # else:
        model = BertWIKIpretrainmodel.from_pretrained(args.bert_model, config=config)
