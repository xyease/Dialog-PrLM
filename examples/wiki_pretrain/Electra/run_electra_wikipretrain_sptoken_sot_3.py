...
parser.add_argument("--bert_model", default="google/electra-base-discriminator", type=str,
...
parser.add_argument("--output_dir",
                    default="../../result/electra_base_wikipretrain_v3/model_save_v1_sptoken3_eot_p2",
                    type=str,
