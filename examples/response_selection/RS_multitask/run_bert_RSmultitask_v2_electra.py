...
from electra_multitask_model import Electramultitaskmodel
...
parser.add_argument("--bert_model", default="../../result/electra_base_zh_wikipretrain_v3/model_save_v1_sptoken3_eot_p2/", type=str,
                    help="Bert pre-trained model selected in the list: bert-base-uncased, "
                    "bert-large-uncased, bert-base-cased, bert-large-cased, bert-base-multilingual-uncased, "
                    "bert-base-multilingual-cased, bert-base-chinese.")

# chinese-electra-180g-base-discriminator google/electra-base-discriminator
parser.add_argument("--orin_bert_model", default="hfl/chinese-electra-180g-base-discriminator", type=str,
                    help="Bert pre-trained model selected in the list: bert-base-uncased, "
                    "bert-large-uncased, bert-base-cased, bert-large-cased, bert-base-multilingual-uncased, "
                    "bert-base-multilingual-cased, bert-base-chinese.")
...
parser.add_argument("--output_dir",
                    default="../../result/alime/RSmatch2_v3_wikipretrain_3_p2_multitask_electra",
                    type=str,
...
def get_dataloader(tokenizer, examples, label_list, tag):
    ...
    #         examples_utt, label_list, args, tokenizer)
    #
...
def main():
    ...
    tokenizer = ElectraTokenizer.from_pretrained(args.orin_bert_model, do_lower_case=args.do_lower_case)
    ...
    if args.do_train:
        ...
        model = Electramultitaskmodel.from_pretrained(args.bert_model, config=config)
        model.to(device)
        if n_gpu > 1:
        ...
        model = Electramultitaskmodel.from_pretrained(args.bert_model, config=config, state_dict=model_state_dict)
