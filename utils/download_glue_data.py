...
def main(arguments):
    ...
    parser.add_argument("--data_dir", help="directory to save data to", type=str, default="../examples/myglue/glue_huggingface/MRPC/")
    parser.add_argument(
        "--tasks", help="tasks to download data for as a comma separated string", type=str, default="MRPC"
    )
    parser.add_argument(
        "--path_to_mrpc",
